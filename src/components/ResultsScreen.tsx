...
interface ResultsScreenProps {
  ...
  onHome: () => void;
  onBack: () => void;
  onSave: () => Promise<void>;                 // Proceed to user info form
}
    ...
    <div className="size-full flex flex-col ">
      ...
      <div className="bg-[rgb(234,239,246)] py-4 px-8 flex items-center justify-between px-[32px] py-[9px]">
        ...
        <button
          ...
          disabled={saving}
          className="bg-[#6B7CCC] hover:bg-[#5A6BB5] disabled:opacity-60 disabled:cursor-not-allowed text-white px-8 py-3 rounded-full transition-colors px-[22px] py-[9px]"
        >
